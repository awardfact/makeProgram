...
public class ItemTemp : MonoBehaviour         // 아이템 정보를 임시 저장하는 스크립트 
{
    ...
    public int GetItem(int getQuantity)
    {
        ...
        if (bigItemType == "Equipment")
        {
            ...
            if(minEmpty != -1)
            {
                ...
                UIManager.instance.item_EquipSlot[minEmpty].coolTime = coolTime;
                UIManager.instance.item_EquipSlot[minEmpty].stayTime = stayTime;
                ...
                UIManager.instance.item_EquipSlot[minEmpty].requireAccumulateLevel = requireAccumulateLevel;
    ...
    public int LoseItem(int loseQuantity)
    {
        ...
        if (bigItemType == "Equipment")
        {
            ...
            if (minEmpty != -1)
            {
                ...
                UIManager.instance.item_EquipSlot[minEmpty].requireAccumulateLevel = 0;
        ...
        else if (bigItemType == "Cash")
        {
            for (int i = 31; i >= 0; i--)
            {
                if (UIManager.instance.item_CashSlot[i].itemName == itemName && UIManager.instance.item_EtcSlot[i].sharePosiible == sharePosiible)
                {
                    minEmpty = i;
                    break;
                }
